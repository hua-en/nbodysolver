import numpy as np
from nbodysolver.nbodysolver import simulate_nbody_and_process, simulate_nbody_and_process_faster
...
def simulate_system_np(system, dt, max_time, g=6.6743e-11):
    return simulate_nbody_and_process_faster(system["r_list"], system["V_list"], system["m_list"], dt, max_time, g)
