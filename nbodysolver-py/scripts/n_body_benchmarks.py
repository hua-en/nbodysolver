...
def rust_acc_solver_faster(): nbodysolver.all_planet_acc_nbody_faster(
...
print("Python Acceleration Results:", all_planet_acc_nbody(
    sun_earth_moon_system["r_list"], sun_earth_moon_system["m_list"], 
    g=6.6743e-11))
print("Rust Acceleration Results 2:", nbodysolver.all_planet_acc_nbody_faster(
...
time_2_5 = timeit("rust_acc_solver_faster()", number=iterations, globals=globals())

print(f"Rust Acceleration Solver: {time_1 / iterations} seconds")
print(f"Numpy Acceleration Solver: {time_2 / iterations} seconds")
print(f"New Rust Acceleration Solver: {time_2_5 / iterations} seconds")
...
def rust_energy_solver_faster(): nbodysolver.total_energy_nbody_faster(
...
print("Python Energy Results:", total_energy_nbody(
    sun_earth_moon_system["r_list"], sun_earth_moon_system["V_list"], 
    sun_earth_moon_system["m_list"]))
print("Rust Energy Results:", nbodysolver.total_energy_nbody_faster(
    sun_earth_moon_system_np["r_list"], sun_earth_moon_system_np["V_list"], 
    sun_earth_moon_system_np["m_list"], g=6.6743e-11))
...
time_4_5 = timeit("rust_energy_solver_faster()", number=iterations, globals=globals())

print(f"Rust Energy Solver: {time_3 / iterations} seconds")
print(f"Numpy Energy Solver: {time_4 / iterations} seconds")
print(f"New Rust Energy Solver: {time_4_5 / iterations} seconds")
...
def rust_3body_solver_faster():
    nbodysolver.simulate_nbody_and_process_faster(sun_earth_moon_system_np['r_list'],
...
time_6_5 = timeit("rust_3body_solver_faster()", number=100, globals=globals())
time_7 = timeit("rust_5body_solver()", number=50, globals=globals())
print(f"Rust 3 Body Simulation Results: {time_6 / 100} seconds")
print(f"Rust 3 Body Simulation Results: {time_6_5 / 100} seconds")
