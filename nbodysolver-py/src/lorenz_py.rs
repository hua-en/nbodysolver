...
pub fn solve_lorenz_py<'py>(py: Python<'py>, coords: (f64, f64, f64), max_time: f64, dt: f64, tau:f64, rho: f64, beta: f64) -> 
    ...
    (x_lst.into_pyarray(py), y_lst.into_pyarray(py), z_lst.into_pyarray(py), t_lst.into_pyarray(py))
}