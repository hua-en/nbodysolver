...
use crate::three_body::{all_planet_acc_nbody_py, total_energy_nbody_py, call_nbody, simulate_nbody_and_process_py};
...
fn nbodysolver(_py: Python, m: &PyModule) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(call_nbody, m)?)?;
